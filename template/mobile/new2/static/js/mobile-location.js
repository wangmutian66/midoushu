...
$('body').on('click', '.area-list p', function () {
  ...
  $('#area').text(province_name+city_name+district_name);
    ...
    success: function(data){
      ...
      if(data.status == 1){
        ...
        for(var i = 0;i < province_count;i++){
          province_html += '<p data-id="'+data.result[i].id+'"  style="cursor:pointer;">'+data.result[i].name+'</p>';
        }
      }
    ...
    success: function (data) {
      ...
      if (data.status == 1) {
        ...
        for (var i = 0; i < city_count; i++) {
          city_html += '<p data-id="' + data.result[i].id + '" style="cursor:pointer;">' + data.result[i].name + '</p>';
        }
      }
    ...
    success: function (data) {
      ...
      if (data.status == 1) {
        ...
        for (var i = 0; i < district_count; i++) {
          district_html += '<p data-id="' + data.result[i].id + '" style="cursor:pointer;">' + data.result[i].name + '</p>';
        }
      }
