...
return	array(	
	'system'=>array('name'=>'系统','child'=>array(
				...
				array('name' => '会员','child'=>array(
						...
						array('name'=>'返利提现','act'=>'tocash','op'=>'User'),
	...
	'company'=>array('name'=>'子公司','child'=>array(
			array('name' => '子公司','child' => array(
					...
					array('name' => '层级管理', 'act'=>'Index', 'op'=>'CompanyLevel'),
					array('name' => '员工管理', 'act'=>'Index', 'op'=>'Staff'),
					array('name' => '推广员管理', 'act'=>'Index', 'op'=>'Staff', 'attr1'=>'t', 'attr2'=>'1'),
					array('name' => '推广员申请', 'act'=>'tk_apply', 'op'=>'Staff'),
			...
			array('name' => '统计','child' => array(
					array('name' => '成员返利', 'act'=>'rebate', 'op'=>'Tongji'),
					array('name' => '员工返利', 'act'=>'staff_rebate', 'op'=>'Tongji'),
				#	array('name' => '推广员', 'act'=>'promote', 'op'=>'Tongji'),
				#	array('name' => '资金池', 'act'=>'pool', 'op'=>'Tongji'),
					array('name' => '订单全返', 'act'=>'allreturn', 'op'=>'Tongji'),
					array('name' => '现金订单全返百分比', 'act'=>'return_percentage', 'op'=>'Tongji'),
					array('name' => '米豆订单全返百分比', 'act'=>'return_percentage&is_red=1', 'op'=>'Tongji'),
					array('name' => '序号列表初始化', 'act'=>'initialize_order', 'op'=>'Tongji'),
					array('name' => '全返列表序号', 'act'=>'xh', 'op'=>'Tongji'),
					array('name' => '现金商城返利信息', 'act'=>'error_order', 'op'=>'Tongji'),
					array('name' => '米豆商城返利信息', 'act'=>'error_order&is_red=1', 'op'=>'Tongji'),
			)),
	)),
