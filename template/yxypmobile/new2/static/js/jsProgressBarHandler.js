  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			width		: 123,										// Width of the progressbar - don't forget to adjust your image too!!!
			/*boxImage	: '/template/mobile/new2/static/images/percentImage.png',			// boxImage : image around the progress bar
			barImage	: '/template/mobile/new2/static/images/percentImage_back.png',*/
			boxImage	: '../static/images/percentImage.png',			// boxImage : image around the progress bar
			barImage	: '../static/images/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
