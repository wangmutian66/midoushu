...
class PHPExcel
{
    ...
    */
    ...
    /**
     * Remove cellXf by index. It is ensured that all cells get their xf index d.
     *
    ...
    /**
     * Eliminate all unneeded cellXf and afterwards  the xfIndex for all cells
    ...
    public function garbageCollect()
    {
        ...
        // remove cellXfs without references and create mapping so we can  xfIndex
        ...
        //  the xfIndex for all cells, row dimensions, column dimensions
        foreach ($this->getWorksheetIterator() as $sheet) {
            // for all cells
            foreach ($sheet->getCellCollection(false) as $cellID) {
                $cell = $sheet->getCell($cellID);
