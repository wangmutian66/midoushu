...
class Ueditor extends Base
{
	...
	*/
    ...
    {
        if(request()->isPost()){
        	/*$returnUrlArray = explode("/",$filePath);
            $key = $returnUrlArray[count($returnUrlArray)-1];*/
            require_once APP_PATH . '/../vendor/Qiniu/Auth.php';
            require_once APP_PATH.'/../vendor/Qiniu/Storage/UploadManager.php';
            require_once APP_PATH.'/../vendor/Qiniu/Storage/FormUploader.php';
