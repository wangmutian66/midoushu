...
class OrderLogic extends Model
{
    ...
    public function getOrderGoods($order_id,$is_send =''){
        ...
        $sql = "SELECT g.*,o.*,(o.goods_num * o.cost_price) AS goods_total FROM __PREFIX__order_goods o ".
...
//        	$btn['delivery_confirm'] = '确认收货';
    ...
    // 订单操作 更新状态
    public function orderProcessHandle($order_id,$suppliers_id,$act,$ext=array()){
    	$updata = array();
    	switch ($act){
    		case 'pay': //付款
