...
#    dump($cartList);die;
    ...
    public function cart3(){
        ...
        if ($_REQUEST['act'] == 'submit_order') {
            $goods_queue = \think\Cache::get('goods_queue');
            if($goods_queue >= 99){
                $this->ajaxReturn(['status' => -99, 'msg' => "当前人数过多请耐心排队!".$goods_queue, 'result' => null]);
            }else{
                \think\Cache::inc('goods_queue',1);
            }
            $pay_name = '';
