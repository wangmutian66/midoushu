...
class Index extends Base {
    ...
    public function index(){
        ...
        $sql .= C('database.prefix')."goods_category as b on a.cat_id=b.id where a.is_yxyp=1 and a.is_allreturn=0 and a.is_hot=1 and a.is_on_sale=1 and a.is_check=1 and a.is_tgy_good=0 order by a.sort";//二级分类下热卖商品
        ...
        $sql2 .= C('database.prefix')."goods_category as b on a.cat_id=b.id where a.is_yxyp=1 and a.is_allreturn=0 and a.is_recommend=1 and a.is_on_sale=1 and a.is_check=1 and a.is_tgy_good=0 order by a.sort";//二级分类下热卖商品
        ...
        $new_goods_where['is_yxyp'] = 1;
        $new_goods_where['is_tgy_good'] = 0;
