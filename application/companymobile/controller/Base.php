...
class Base extends Controller { 
   ...
   /**
    ...
    function __construct() 
    {
        ...
        if(isMobile()) $this->redirect('/StoreMobile');
    ...
    public function _initialize() 
    {
        ...
        if(in_array(ACTION_NAME,array('login','logout','vertify','tree','doLogin'))){
            ...
            if(session('company.cid') > 0 ){
                ...
                $this->error('请先登录',U('/companymobile/System/login'),1);
            }
        }
        $this->public_assign();
    }
   ...
   /**
    ...
    {
        $company_info = db('company')->cache("company_{$this->company_id}")->find($this->company_id);
