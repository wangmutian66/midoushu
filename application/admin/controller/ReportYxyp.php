...
class ReportYxyp extends Base{
    ...
    public function index(){
        ...
        $today['today_amount'] = M('order_yxyp')->where("add_time>$now AND (pay_status=1 or pay_code='cod') and order_status in(1,2,4)")->sum('total_amount');//今日销售总额
        $today['today_order']  = M('order_yxyp')->where("add_time>$now and (pay_status=1 or pay_code='cod')")->count(); //今日支付订单数
        $today['cancel_order'] = M('order_yxyp')->where("add_time>$now AND order_status=3")->count(); //今日取消订单
        ...
        $res = Db::name("order_yxyp".$select_year)
    ...
    public function supplierTop(){
        ...
        $count = Db::name('order_yxyp')->alias('o')->where($order_where)->group('o.suppliers_id')->count();  //统计数量
        $Page = new Page($count,20);
        $list = Db::name('order_yxyp')->alias('o')
    ...
    public function userTop(){
        ...
        $count = Db::name('order_yxyp')->alias('o')->where($order_where)->group('o.user_id')->count();  //统计数量
        $Page = new Page($count,20);
        $list = Db::name('order_yxyp')->alias('o')
    ...
    public function saleOrder(){
        ...
        $order_count = Db::name('order_yxyp')->alias('o')->where($order_where)->whereIn('order_status','1,24')->count();
        $Page = new Page($order_count,20);
        $order_list = Db::name('order_yxyp')->alias('o')
    ...
    public function saleList(){
        ...
        $count = Db::name('order_yxyp_goods')->alias('og')
        ...
        $res = Db::name('order_yxyp_goods')->alias('og')->field('og.*,o.order_sn,o.shipping_name,o.pay_name,o.add_time')
            ->join('order_yxyp o','og.order_id=o.order_id ','left')
            ->join('goods_yxyp g','og.goods_id = g.goods_id','left')
    ...
    //    $end_time    = $this->begin+24*60*60;
        ...
        $order_list = Db::name('order_yxyp_goods')->alias('og')->field('og.*,o.order_sn,o.shipping_name,o.pay_name,o.add_time')
            ->join('order_yxyp o','og.order_id= o.order_id ','left')
            ->join('goods_yxyp g','og.goods_id = g.goods_id','left')
            ->where($where)
            ->order('o.add_time desc')->select();
    ...
    public function user(){
        ...
        $res = M('order_yxyp')->cache(true)->distinct(true)->field('user_id')->select();
    ...
    public function finance(){
        ...
        $sql .= "sum(a.coupon_price) as coupon_amount,FROM_UNIXTIME(a.add_time,'%Y-%m-%d') as gap from __PREFIX__order_yxyp a left join __PREFIX__order_yxyp_goods b on a.order_id=b.order_id ";
    ...
    public function expense_log(){
        ...
        $count = M('expense_yxyp_log')->where($map)->count();
        $page = new Page($count);
        $lists  = M('expense_yxyp_log')->where($map)->limit($page->firstRow.','.$page->listRows)->select();
        $this->assign('page',$page->show());
  ...
  /**
    ...
    public function financeDetail(){
        ...
        $order_count = Db::name('order_yxyp')->alias('o')->join('order_yxyp_goods og','o.order_id = og.order_id','left')->join('users u','u.user_id = o.user_id','left')->where($order_where)->group('o.order_id')->count();
