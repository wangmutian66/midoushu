...
// 随机字符串
  private function createNonceStr($length = 16) {
    ...
    public function getAccessToken(){
        ...
        $web_expires = time() + 7000;
        M('wx_user')->where("id = 25")->save(array('web_access_token'=>$return['access_token'],'web_expires'=>$web_expires));      
        return $return['access_token'];*/
    }    
    
    // 获取一般的 access_token
    public function get_access_token($repload=1){
        //判断是否过了缓存期
