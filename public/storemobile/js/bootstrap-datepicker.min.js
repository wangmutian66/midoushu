...
function(t) {
    ...
    d.prototype = {
        ...
        _resolveViewName: function(e) {
            ...
            function(i, a) {
                if (e === i || -1 !== t.inArray(e, a.names)) return e = i,
                !1
            }),
            e
        },
        ...
        _process_options: function(e) {
            ...
            if (s.defaultViewDate instanceof Date || "string" == typeof s.defaultViewDate) s.defaultViewDate = m.parseDate(s.defaultViewDate, o, s.language, s.assumeNearbyYear);
        ...
        place: function() {
            ...
            if ("auto" === g && (f = -n + p - i, g = f < 0 ? "bottom": "top"), this.picker.addClass("datepicker-orient-" + g), "top" === g ? p -= i + parseInt(this.picker.css("padding-top")) : p += d, this.o.rtl) {
                var D = s - (u + c);
                this.picker.css({
                    top: p,
                    right: D,
        ...
        fillMonths: function() {
            for (var t, e = this._utc_to_local(this.viewDate), i = "", a = 0; a < 12; a++) t = e && e.getMonth() === a ? " focused": "",
            i += '<span class="month' + t + '">' + D[this.o.language].monthsShort[a] + "</span>";
        ...
        _fill_yearsView: function(i, a, s, n, o, r, h) {
            for (var l, d, c, u = "",
            p = s / 10,
            f = this.picker.find(i), g = Math.floor(n / s) * s, D = g + 9 * p, m = Math.floor(this.viewDate.getFullYear() / p) * p, y = t.map(this.dates,
            function(t) {
            ...
            if (!isNaN(o) && !isNaN(r)) {
                ...
                for (var w, k, _ = []; g.valueOf() < v;) {
                    ...
                    this.o.beforeShowDay !== t.noop && (s = this.o.beforeShowDay(this._utc_to_local(g)), s === e ? s = {}: "boolean" == typeof s ? s = {
                        ...
                        classes: s
                    }), !1 === s.enabled && k.push("disabled"), s.classes && (k = k.concat(s.classes.split(/\s+/))), s.tooltip && (a = s.tooltip), s.content && (U = s.content)),
                ...
                var x = D[this.o.language].monthsTitle || D.en.monthsTitle || "Months",
                ...
                }), (o < h || o > d) && V.addClass("disabled"), o === h && V.slice(0, l).addClass("disabled"), o === d && V.slice(c + 1).addClass("disabled"), this.o.beforeShowMonth !== t.noop) {
                    var S = this;
                    t.each(V,
                    function(i, a) {
        ...
        click: function(e) {
            ...
            s.hasClass("disabled") || (s.hasClass("month") || s.hasClass("year") || s.hasClass("decade") || s.hasClass("century")) && (this.viewDate.setUTCDate(1), n = 1, 1 === this.viewMode ? (r = s.parent().find("span").index(s), o = this.viewDate.getUTCFullYear(), this.viewDate.setUTCMonth(r)) : (r = 0, o = Number(s.text()), this.viewDate.setUTCFullYear(o)), this._trigger(m.viewModes[this.viewMode - 1].e, this.viewDate), this.viewMode === this.o.minViewMode ? this._setDate(i(o, r, n)) : (this.setViewMode(this.viewMode - 1), this.fill())),
        ...
        navArrowsClick: function(e) {
            ...
            0 !== this.viewMode && (a *= 12 * m.viewModes[this.viewMode].navStep),
            ...
            if (!this.updating) {
                ...
                if (a !== e) {
                    ...
                    if ( - 1 !== o) {
                        ...
                        else if (s > this.dates[h]) for (; h < l && s > this.dates[h];) this.pickers[h++].setUTCDate(s);
                        this.updateDates(),
        ...
        parseDate: function(i, s, n, o) {
            ...
            if (l.length !== C.length && (C = t(C).filter(function(e, i) {
                ...
                for (p = 0, T = C.length; p < T; p++) {
                    ...
                    case "MM":
                        w = t(D[n].months).filter(h),
                        v = t.inArray(w[0], D[n].months) + 1;
                        break;
                    case "M":
                        w = t(D[n].monthsShort).filter(h),
                        v = t.inArray(w[0], D[n].monthsShort) + 1
                    }
                    k[c] = v
                }
                var M, U;
                for (p = 0; p < _.length; p++)(U = _[p]) in k && !isNaN(k[U]) && (M = new Date(i), b[U](M, k[U]), isNaN(M) || (i = M))
            }
            return i
        },
